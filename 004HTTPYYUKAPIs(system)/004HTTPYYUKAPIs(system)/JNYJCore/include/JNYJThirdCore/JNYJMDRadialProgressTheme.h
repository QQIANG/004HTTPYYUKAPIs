...
@interface JNYJMDRadialProgressTheme : NSObject
...
// Color of the label text.
@property (strong, nonatomic) UIColor *labelColor_detail;

// Shall we drop a shadow ?
@property (assign, nonatomic) BOOL dropLabelShadow_detail;

// Shadow color of the label text.
@property (strong, nonatomic) UIColor *labelShadowColor_detail;

// Shadow offset
@property (assign, nonatomic) CGSize labelShadowOffset_detail;

// Font to use in the label.
@property (strong, nonatomic) UIFont *font_detail;
